...
// const cycling1 = new Cycling([39, -12], 8.5, 30, 180);
...
class App {
    ...
    _loadMap(position) {
        ...
        // console.log(latitude, longitude);//42.8728872 74,6110374
        // console.log(`https://www.google.com/maps/@${latitude},${longitude}`);

        //code implemented by me:
        const coords = [latitude, longitude];
        //Copied from Leaflet page:
        this.#map = L.map('map').setView(coords, this.#mapZoomLevel);
        // const map = L.map('map').setView([42.872, -74.611], 13);
...
`;
        ...
        <div class="workout__details">
          ...
          <div class="workout__details">
            <span class="workout__icon">Elevation:</span>
